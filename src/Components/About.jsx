        ...
        <>
            ...
            <section data-aos="zoom-in-right">
                <div className='max-w-7xl mx-auto px-3 py-10 grid grid-cols-1 md:grid-cols-2 gap-8'>
                    <div className="order-2 md:order-1 space-y-4">
                        ...
                        <h2 className='text-center text-xl sm:text-2xl md:text-3xl text-purple-600'>About Us – Aarana International</h2>
            ...
            <section>
                <div className='max-w-6xl mx-auto my-10 px-3'>
                    <h2 className="text-center text-xl text-purple-600 sm:text-2xl md:text-3xl py-3 ">Our Product Range</h2>
                    <div className="p-2 sm:p-3 md:p-4">
                        <p className='text-center text-sm sm:text-base text-gray-600  max-w-3xl mx-auto'>Food businesses choose Aarana International because of our focus on dependable ingredients and professional service. We aim to provide products that meet the needs of commercial kitchens and large-scale food production</p>
                    </div>
                    <div className="p-2 sm:p-3 md:p-4">
                        <div className='mx-auto grid grid-cols-1 md:grid-cols-3 gap-10'>
                            <div className='overflow-hidden relative group rounded-2xl'>
                                ...
                                <div><h2 className="text-center text-lg sm:text-xl md:text-2xl text-purple-600 py-3 ">Cocoa Powder (Natural & Alkalized)</h2></div>
                            </div>
                            <div className='overflow-hidden relative group rounded-2xl'>
            ...
            <section>
                <div className='max-w-4xl mx-auto px-3 '>
                    <h2 className="text-center text-xl text-purple-600 sm:text-2xl md:text-3xl font-semibold mb-6">Our Commitment to Quality</h2>
                    <div className=''>
                        <p className="text-center text-sm sm:text-base text-gray-600 mt-6 leading-relaxed">Quality is at the heart of everything we do at Aarana International. We understand that bakeries and food businesses rely on ingredients that perform consistently in every batch. From cocoa powder used in cakes and brownies to fruit toppings used in desserts and pastries, every product we supply is chosen with strict attention to quality standards.</p>
                        <p className="text-center text-sm sm:text-base text-gray-600 mt-6 leading-relaxed">Quality is at the heart of everything we do at Aarana International. We understand that bakeries and food businesses rely on ingredients that perform consistently in every batch. From cocoa powder used in cakes and brownies to fruit toppings used in desserts and pastries, every product we supply is chosen with strict attention to quality standards.</p>
                    </div>
                </div>
            </section>
            <section className="max-w-6xl mx-auto py-16 px-4">
                <div data-aos="flip-down" className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 p-6 sm:p-8 border border-gray-100">
                        ...
                        <h2 className="text-center text-xl text-purple-600 sm:text-2xl md:text-3xl font-semibold mb-6">
                            Why Choose Aarana International
                        </h2>
                        <p className="text-center text-sm sm:text-base text-gray-600 mt-6 leading-relaxed"><p className="text-center text-sm sm:text-base text-gray-600 py-6  leading-relaxed">Food businesses choose Aarana International because of our focus on dependable ingredients and professional service. We aim to provide products that meet the needs of commercial kitchens and large-scale food production.</p></p>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 p-6 sm:p-8 border border-gray-100">
                        ...
                        <p className="text-center text-sm sm:text-base text-gray-600 py-6 leading-relaxed">Aarana International works closely with a variety of food industry professionals. Our ingredients are widely used by:</p>
                        <ul className="space-y-3 list-disc list-inside text-gray-700">
                        ...
                        <p className="text-center text-sm sm:text-base text-gray-600 mt-6 leading-relaxed">
                            By supplying essential bakery ingredients and food preparation products, Aarana International helps businesses streamline their ingredient sourcing and maintain consistent product quality.
                        </p>
            ...
            <section>
                <div className='max-w-4xl mx-auto px-3 '>
                    <h2 className="text-center text-xl text-purple-600 sm:text-2xl md:text-3xl font-semibold mb-6">Our Vision</h2>
                    <div className=''>
                        <p className="text-center text-sm sm:text-base text-gray-600 py-6 leading-relaxed">The vision of Aarana International is to become a trusted name in the bakery ingredient industry by providing high-quality products that support the growth of bakeries, restaurants, and food brands. We aim to build long-term relationships with our customers by focusing on reliability, quality, and professional service.</p>
